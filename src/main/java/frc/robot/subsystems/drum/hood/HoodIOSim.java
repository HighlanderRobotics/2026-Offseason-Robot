...
public class HoodIOSim extends HoodIO {
    ...
    public HoodIOSim(CANBus canBus) {
        ...
        notifier = new Notifier(() -> {
            ...
            simState.setRawRotorPosition(Units.radiansToRotations(physicsSim.getAngleRads() * DrumSubsystem.HOOD_GEAR_RATIO));
            simState.setRotorVelocity(Units.radiansToRotations(physicsSim.getVelocityRadPerSec() * DrumSubsystem.HOOD_GEAR_RATIO));
        });
